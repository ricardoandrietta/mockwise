...
{{--    </form>--}}
    ...
    <div class="mt-6 flex items-center justify-between text-center">
        <p style="color: #9ca3af">
            By signing in, you agree to Mock Wise's
            <br /><a class="text-sm text-blue-400 hover:text-blue-300" href="{{route('terms')}}">Terms & Conditions</a> and <a class="text-sm text-blue-400 hover:text-blue-300" href="{{route('privacy')}}">Privacy Policy</a>.
            <br />First time users will have an account created automatically.
    </div>
</div>
