    ...
    <form wire:submit="login" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-blue-400 hover:text-blue-300" href="{{ route('password.request') }}" wire:navigate>
                    {{ __('Forgot password?') }}
                </a>
            @endif
        </div>
        ...
        <a href="{{route('auth.redirect', \MockWise\Domain\SocialLogin\ProvidersEnum::Google->value)}}" class="hover:opacity-90 focus:outline-none focus:ring-2 text-black px-4 py-3 rounded-lg flex items-center justify-center gap-3 bg-gray-100">
        ...
        <a href="{{route('auth.redirect', \MockWise\Domain\SocialLogin\ProvidersEnum::Github->value)}}" class="hover:opacity-90 focus:outline-none focus:ring-2 text-black px-4 py-3 rounded-lg flex items-center justify-center gap-3 bg-gray-100">
            <span class="w-5 h-5 flex-shrink-0">
