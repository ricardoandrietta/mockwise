...
class ClaudeAdapter implements AIProviderInterface
{
    ...
    public function __construct()
    {
        ...
        $this->apiEndpoint = config('services.anthropic.api_endpoint', 'https://api.anthropic.com/v1/messages');
    ...
    {
        $systemPrompt = $options['system_prompt'] ?? 'You are a helpful API mock generator assistant. Generate only valid JSON without explanations or comments.';
